        ...
        <div class="qutNumbox">
          ...
          >
            <animated-number
              ...
              v-if="show"
            />
            <p class="antext">Manufacturing Bases</p>
          </div>
          <div 
            class="qutNum"
            v-waypoint="{
          ...
          >
            <animated-number
              ...
              v-if="show"
            />
            <p class="antext"> Overseas Warehouses</p>
          </div>
          <div 
            class="qutNum"
            v-waypoint="{
          ...
          >
            <animated-number
              ...
              v-if="show"
            />
            <p class="antext"> Overseas Branches</p>
          </div>
          <div 
            class="qutNum"
            v-waypoint="{
          ...
          >
            <animated-number
              ...
              v-if="show"
            />
            <p class="antext">Cumulative Solar Panels Shipments</p>
          </div>
          <div 
            class="qutNum"
            v-waypoint="{
          ...
          >
            <animated-number
              ...
              v-if="show"
            />
            <p class="antext">Cumulative Solar Kits Shipments</p>
          </div>
        </div>
      </div>
      <div class="content">
